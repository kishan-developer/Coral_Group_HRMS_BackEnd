...
// GET /api/v1/users/hr-dashboard-overview - Get HR Overview metrics with period and vertical filters
router.get('/hr-dashboard-overview', getHRDashboardOverview);
